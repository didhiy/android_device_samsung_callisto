...
#    vendor/samsung/callisto/proprietary/lib/libsensorservice.so:system/lib/libsensorservice.so 

# 3D libGLES_android is optional
PRODUCT_COPY_FILES += \
...
# OMX libraries
PRODUCT_COPY_FILES += \
    vendor/samsung/callisto/proprietary/omx/libdivxdrmdecrypt.so:system/lib/libdivxdrmdecrypt.so \
    vendor/samsung/callisto/proprietary/omx/libmm-adspsvc.so:system/lib/libmm-adspsvc.so \
    vendor/samsung/callisto/proprietary/omx/libmm-omxcore.so:system/lib/libmm-omxcore.so \
    vendor/samsung/callisto/proprietary/omx/libmmparser.so:system/lib/libmmparser.so \
    vendor/samsung/callisto/proprietary/omx/libmmparser_divxdrmlib.so:system/lib/libmmparser_divxdrmlib.so \
    vendor/samsung/callisto/proprietary/omx/libomadrm.so:system/lib/libomadrm.so \
    vendor/samsung/callisto/proprietary/omx/libOmxAacDec.so:system/lib/libOmxAacDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxAacEnc.so:system/lib/libOmxAacEnc.so \
    vendor/samsung/callisto/proprietary/omx/libOmxAdpcmDec.so:system/lib/libOmxAdpcmDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxAmrDec.so:system/lib/libOmxAmrDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxAmrEnc.so:system/lib/libOmxAmrEnc.so \
    vendor/samsung/callisto/proprietary/omx/libOmxAmrRtpDec.so:system/lib/libOmxAmrRtpDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxAmrwbDec.so:system/lib/libOmxAmrwbDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxEvrcHwDec.so:system/lib/libOmxEvrcHwDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxEvrcEnc.so:system/lib/libOmxEvrcEnc.so \
    vendor/samsung/callisto/proprietary/omx/libOmxH264Dec.so:system/lib/libOmxH264Dec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxMp3Dec.so:system/lib/libOmxMp3Dec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxMpeg4Dec.so:system/lib/libOmxMpeg4Dec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxQcelpHwDec.so:system/lib/libOmxQcelpHwDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxQcelp13Enc.so:system/lib/libOmxQcelp13Enc.so \
    vendor/samsung/callisto/proprietary/omx/libOmxWmaDec.so:system/lib/libOmxWmaDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxWmvDec.so:system/lib/libOmxWmvDec.so \
    vendor/samsung/callisto/proprietary/omx/libOmxVidEnc.so:system/lib/libOmxVidEnc.so \
    vendor/samsung/callisto/proprietary/omx/libomx_aacdec_sharedlibrary.so:system/lib/libomx_aacdec_sharedlibrary.so \
    vendor/samsung/callisto/proprietary/omx/libomx_amrdec_sharedlibrary.so:system/lib/libomx_amrdec_sharedlibrary.so \
    vendor/samsung/callisto/proprietary/omx/libomx_amrenc_sharedlibrary.so:system/lib/libomx_amrenc_sharedlibrary.so \
    vendor/samsung/callisto/proprietary/omx/libomx_avcdec_sharedlibrary.so:system/lib/libomx_avcdec_sharedlibrary.so \
    vendor/samsung/callisto/proprietary/omx/libomx_mp3dec_sharedlibrary.so:system/lib/libomx_mp3dec_sharedlibrary.so \
    vendor/samsung/callisto/proprietary/omx/libomx_m4vdec_sharedlibrary.so:system/lib/libomx_m4vdec_sharedlibrary.so \
    vendor/samsung/callisto/proprietary/omx/libomx_sharedlibrary.so:system/lib/libomx_sharedlibrary.so 
